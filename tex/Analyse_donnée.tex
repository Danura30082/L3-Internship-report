...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \frame{\includegraphics[width=\textwidth,trim=4 1cm 4 5,clip]{img/graph/Correlation_sonde_haute.png}}
        \caption{Correlation pour la sonde haute}
        \label{fig:correlation_sonde_haute}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
        \centering
        \frame{\includegraphics[width=\textwidth,trim=4 4 4 4,clip]{img/graph/Correlation_sonde_basse.png}}
