...
\label{ssec_boxbore}
\includegraphics[width=0.9\textwidth]{cameco/3.0.1-1MiningMethods-Boxhole.jpg}
...
\label{ssec_jetbore}
\includegraphics[width=0.9\textwidth]{cameco/3.0.1-2MiningMethods-JetBore.jpg}
...
\label{ssec_insitu}
\includegraphics[width=0.9\textwidth]{cameco/3.0.1-3MiningMethods-ISR.jpg}
...
\includegraphics[width=0.9\textwidth]{cameco/3.0.1-4MiningMethods-Raisebore.jpg}
